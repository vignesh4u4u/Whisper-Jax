...
class ConversationalChatBot:
    ...
    def filter_answer(self,input_query,retriver):
        ...
        model1 = HuggingFaceHub(repo_id="mistralai/Mistral-7B-Instruct-v0.1",
        ...
        result = page_content + "\n\n\n" +"above text into answer the question."+input_query
    ...
    def content_evaluation(self,page_content,input_query):
        model1 = HuggingFaceHub(repo_id="mistralai/Mixtral-8x7B-Instruct-v0.1",
                                model_kwargs={"temperature": 0.2, "seed": 42,
                                              'repetition_penalty': 1.1,
                                              "max_new_tokens": 3000,
                                              "max_length": 3000})
        template = """
